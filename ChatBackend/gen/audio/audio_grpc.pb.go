...
const (
	AudioService_Recognize_FullMethodName = "/audio.AudioService/Recognize"
)
...
type AudioServiceClient interface {
	Recognize(ctx context.Context, in *AudioRequest, opts ...grpc.CallOption) (*AudioResponse, error)
}
...
func (c *audioServiceClient) Recognize(ctx context.Context, in *AudioRequest, opts ...grpc.CallOption) (*AudioResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AudioResponse)
	err := c.cc.Invoke(ctx, AudioService_Recognize_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AudioServiceServer interface {
	Recognize(context.Context, *AudioRequest) (*AudioResponse, error)
...
func (UnimplementedAudioServiceServer) Recognize(context.Context, *AudioRequest) (*AudioResponse, error) {
...
func _AudioService_Recognize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AudioRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AudioServiceServer).Recognize(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AudioService_Recognize_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AudioServiceServer).Recognize(ctx, req.(*AudioRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _AudioService_Recognize_Handler,
		},
	},
