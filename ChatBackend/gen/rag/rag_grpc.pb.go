...
const (
	RAGService_Generate_FullMethodName = "/rag.RAGService/Generate"
)
...
type RAGServiceClient interface {
	Generate(ctx context.Context, in *RAGRequest, opts ...grpc.CallOption) (*RAGResponse, error)
}
...
func (c *rAGServiceClient) Generate(ctx context.Context, in *RAGRequest, opts ...grpc.CallOption) (*RAGResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RAGResponse)
	err := c.cc.Invoke(ctx, RAGService_Generate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRAGServiceServer) Generate(context.Context, *RAGRequest) (*RAGResponse, error) {
...
func _RAGService_Generate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RAGRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RAGServiceServer).Generate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RAGService_Generate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RAGServiceServer).Generate(ctx, req.(*RAGRequest))
	}
