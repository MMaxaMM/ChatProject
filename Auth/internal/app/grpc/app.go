...
import (
	...
	handlers "github.com/MMaxaMM/ChatProject/Auth/internal/grpc"
...
func New(log *slog.Logger, port int, auth handlers.AuthGRPC) *App {
	gRPCServer := grpc.NewServer()
	handlers.Register(gRPCServer, auth)
